...
// */
//
//public class ProximitySensorService extends IntentService implements SensorEventListener,
//        Constants.DEFAULT_VALUES, Constants.CALLBACK_ACTIONS {
//
//
//    private final String LOG_TAG = this.getClass().getSimpleName();
...
//    private Sensor mProximity;
//    private Context contextToCallback;
//    private boolean sensorEventReceived = false;
//    private int carConnectedServiceStartId;
//
//    public class LocalBinder extends Binder {
//        public ProximitySensorService getService() {
...
//    @Override
//    public void onDestroy() {
//        if (sensorEventReceived) {
//            Log.d(LOG_TAG, "onDestroy");
//            mSensorManager.unregisterListener(this);
//            EventBus.getDefault().unregister(this);
//            super.onDestroy();
//        } else {
//            Log.e(LOG_TAG, "Service not received sensor event yet! It will not be destroyed!");
//            mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE);
//            mProximity = mSensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
//        }
//    }
...
//        Log.d(LOG_TAG, "Proximity sensor distance = " + Float.toString(distance));
//        if (distance < 2.5) {
//            AppBroadcastReceiver.proximityState = ProximityState.NEAR;
//        } else {
//            AppBroadcastReceiver.proximityState = ProximityState.FAR;
//        }
//
//        ((CarConnectedService) contextToCallback).callback(PROXIMITY_CHECK_COMPLETED,
//                carConnectedServiceStartId);
